...
const routes: Routes = [
  ...
  { path: 'updatecourseOffered/:id', component: UpdateCourseOfferedComponent },
  { path: 'courseOffereddetails/:id', component: CourseOfferedDetailsComponent },
  ...
  { path: 'createRoutinedetails/:id', component: CreateRoutineDetailsComponent },

  { path: 'program/:id', component: ProgramComponent, data: { title: 'Program' } },
  { path: 'course/:id', component: CourseComponent, data: { title: 'Course' } },
  { path: 'batch/:id', component: BatchComponent, data: { title: 'Batch' } },
  { path: 'faculty/:id', component: FacultyComponent, data: { title: 'Faculty' } },
  { path: 'courseOffered/:id', component: CourseOfferedComponent, data: { title: 'CourseOffered' } },
  { path: 'routine/:id', component: RoutineComponent, data: { title: 'Routine' } },
