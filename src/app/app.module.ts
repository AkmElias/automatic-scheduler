...
@NgModule({
  ...
  providers: [UserService, UserapiService, ApiService,
  DepartmentapiService,  ProgramapiService, CourseapiService,
  BatchapiService,SectionapiService, FacultyapiService, ExamapiService, RoomapiService,
  TimeSlotapiService, CourseOfferedapiService, CreateRoutineapiService, RoutineapiService, AuthGuard],
