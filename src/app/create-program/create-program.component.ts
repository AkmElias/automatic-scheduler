...
export class CreateProgramComponent {
  ...
  constructor(private programService: ProgramapiService, private router: Router, private api: DepartmentapiService)
  {
    this.Program = {programCode: '', pro_name: '' , pro_shortForm: '', DepartmentID: '', pro_type: ''};
    this.getDepartments();
  }
