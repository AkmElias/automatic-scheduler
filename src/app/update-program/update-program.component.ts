...
departments: any = [];
  ...
  constructor(private route: ActivatedRoute, private programService: ProgramapiService,
  private router: Router, private api: DepartmentapiService)
  {
 this.getDepartments();
  }
  ...
  ngOnInit() {
    ...
    this.programService.getProgramsByProgramCode(this.id)
      .subscribe(data => {
        console.log(data)
        this.program = data;
